    ...
    <div className="h-full w-full overflow-hidden relative bg-white">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end">
        ...
        <motion.div
          ...
          transition={{ ...SPRING_ENTER, delay: baseDelay, opacity: { duration: 1.2, delay: baseDelay, ease: [0.22, 1, 0.36, 1] as const } }}
        >
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Links */}
              {profile?.links && (
                <motion.div variants={slideFromBottom} className="flex gap-3 mt-4">
